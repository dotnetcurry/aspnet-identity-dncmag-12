...
namespace IdentitySample.Models
{
    ...
    public class SignInHelper
    {
        ...
        public async Task<SignInStatus> PasswordSignIn(string userName, string password, bool isPersistent, bool shouldLockout)
        {
            ...
            //Return True if the user is lockout
            await UserManager.IsLockedOutAsync(user.Id);
            //Increament the accessfail count for the user
            //If the failed access count is greater than 
            //or equal to MaxFailedAccessAttemptsBeforeLockout
            //then the user will be locked for the time span of the 
            //lockouttimespan
            await UserManager.AccessFailedAsync(user.Id);
            //Set the lockout is enabled for the user
